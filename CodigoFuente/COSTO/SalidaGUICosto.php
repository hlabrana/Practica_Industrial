...
<body>
	<br>
	<center>
	<h2>Seleccione la forma de salida del Informe de Costo:</h2><br>
  <form action="ExportarCSVCostoGestionable.php">
   <input type="submit" value="Descargar Repositorio Gestionable" />
  </form>
  <br>
	<form action="ExportarCSVCostoNoGestionable.php">
   <input type="submit" value="Descargar Repositorio No Gestionable" />
  </form>
  <br>
  <form action="ExportarVistaCosto.php">
   <input type="submit" value="Descargar Resumen Por Grupo Mayorista" />
  </form>
	<br>
</center>
...
$result = mysqli_query($conexion,"SELECT * FROM VISTA_RESUMEN_COSTO GROUP BY totalgeneral ASC");
